...
export default function LoginBlockShowcase() {
  return (
    <BlockPage
      title="Login"
      description="Authentication login page blocks."
    >
      <BlockPreview
        title="Login 01 - Centered"
        description="Centered login form with social auth"
        files={loginFiles1}
